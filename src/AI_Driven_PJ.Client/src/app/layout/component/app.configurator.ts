...
@Component({
    ...
    `,
    host: {
        class: 'layout-config-panel hidden'
    }
})
export class AppConfigurator {
    ...
    primaryColors = computed<SurfacesType[]>(() => {
        const presetPalette = this.getActivePreset().primitive ?? {};
    ...
    getPresetExt() {
        const color: SurfacesType = this.primaryColors().find((c) => c.name === this.selectedPrimaryColor()) || this.primaryColors().find((c) => c.name === 'orange') || {};
        const preset = this.getActivePresetName();
    ...
    onPresetChange(event: any) {
        const presetName = this.isPresetName(event) ? event : 'Aura';
    ...
    private getActivePresetName(): PresetName {
        const preset = this.layoutService.layoutConfig().preset;
        return this.isPresetName(preset) ? preset : 'Aura';
    }

    private getActivePreset() {
        return presets[this.getActivePresetName()];
    }
